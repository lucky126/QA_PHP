...
class Page{
    ...
    public function show() {
        ...
        $up_page = '<li'.($up_row > 0 ? '':' class="disabled"').'><a href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>';

        //下一页
        $down_row  = $this->nowPage + 1;
        $down_page = '<li'.(($down_row <= $this->totalPages) ? '':' class="disabled"').'><a href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>';
