...
define("VERSION", '2015-04-21 by luckynet');
...
switch ($step) {
    ...
    case '4':
        if (intval($_GET['install'])) {
            ...
            $time = time();
            $query = "INSERT INTO `{$dbPrefix}user` VALUES ('1', '3', '{$email}','{$password}','超级管理员', '我是超级管理员','0', '', '', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '0', '0', '0', '0', '0', '0000-00-00 00:00:00', '0');";
            mysql_query($query);
            $message = '成功添加管理员<br />成功写入配置文件<br>安装完成．';

            file_put_contents(str_replace('Application/','',SITEDIR) . "/Common/Conf/systemConfig.php", ("<?php\treturn " . var_export($config, true) . ";?>"));
            $arr = array('n' => 200, 'msg' => $message);
            die(json_encode($arr));
        }
