                    ...
                    <div class="server">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="dbprefix" id="dbprefix" value="bbs_" class="input"></td>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sitename" value="互动交流系统" class="input"></td>
                        ...
                        <table width="100%">
                            <tr>
                                <td class="td1" width="100">默认管理员信息</td>
                                <td class="td1" width="200">&nbsp;</td>
                                <td class="td1">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td><div id="J_install_tip_manager_name"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">密码：</td>
